...
var DATE_MAX_YEAR, DATE_MIN_YEAR, DATE_SPLITS, GRAPHS, L33T_TABLE, RANKED_DICTIONARIES, REGEXEN, adjacency_graphs, build_ranked_dict, matching, scoring;
...
matching = {
  ...
  set_frequency_lists: function(frequency_lists) {
    var lst, name, results;
    results = [];
    for (name in frequency_lists) {
      lst = frequency_lists[name];
      results.push(RANKED_DICTIONARIES[name] = build_ranked_dict(lst));
    }
    return results;
  },
